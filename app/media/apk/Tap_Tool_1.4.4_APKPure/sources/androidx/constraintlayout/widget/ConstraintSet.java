...
public class ConstraintSet {
    ...
    public String derivedState = RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED;
    ...
    class WriteXmlEngine {
        ...
        String getName(int id) {
            if (this.idMap.containsKey(Integer.valueOf(id))) {
                return "@+id/" + this.idMap.get(Integer.valueOf(id)) + RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED;
            } else if (id == 0) {
