...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    */
    ...
    public class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (child.mBottom.mTarget != null) {
                StringBuilder sb5 = new StringBuilder();
                sb5.append("B");
                sb5.append(child.mBottom.mTarget.mType == ConstraintAnchor.Type.TOP ? RequestConfiguration.MAX_AD_CONTENT_RATING_T : "B");
                str3 = sb5.toString();
            } else {
                str3 = "__";
            }
            ...
            Log.v(MotionLayout.TAG, str + sb12 + " ---  " + child);
        }
    ...
    private class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            String str = RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED + (((int) (((min2 * 100.0f) / Math.abs(f3 - f)) + 0.5d)) / 100.0f);
            getTextBounds(str, this.mTextPaint);
            ...
            String str2 = RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED + (((int) (((max2 * 100.0f) / Math.abs(f4 - f2)) + 0.5d)) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float x, float y, int viewWidth, int viewHeight) {
            String str = RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED + (((int) ((((x - (viewWidth / 2)) * 100.0f) / (MotionLayout.this.getWidth() - viewWidth)) + 0.5d)) / 100.0f);
            getTextBounds(str, this.mTextPaint);
            ...
            String str2 = RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED + (((int) ((((y - (viewHeight / 2)) * 100.0f) / (MotionLayout.this.getHeight() - viewHeight)) + 0.5d)) / 100.0f);
            getTextBounds(str2, this.mTextPaint);
    ...
    */
    ...
    public void getAnchorDpDt(int mTouchAnchorId, float pos, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        if (viewById == null) {
            resourceName = RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED + mTouchAnchorId;
        } else {
