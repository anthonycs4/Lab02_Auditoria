...
public class LinearSystem {
    ...
    */
    ...
    private String getDisplaySize(int i) {
        ...
        int i4 = i3 / 1024;
        if (i4 > 0) {
            return RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED + i4 + " Mb";
        } else if (i3 > 0) {
            return RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED + i3 + " Kb";
        } else {
            return RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED + i2 + " bytes";
        }
    }
