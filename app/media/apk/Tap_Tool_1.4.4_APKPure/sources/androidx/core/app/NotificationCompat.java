...
public class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor builder) {
            ...
            if (this.mConversationTitle != null && this.mIsGroupConversation.booleanValue()) {
                ...
                builder.getBuilder().setContentTitle(RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED);
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            CharSequence name = person == null ? RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED : message.getPerson().getName();
    ...
    public static class Action {
        ...
        public Action(int icon, CharSequence title, PendingIntent intent) {
            this(icon != 0 ? IconCompat.createWithResource(null, RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED, icon) : null, title, intent);
        }
        ...
        public Action(int icon, CharSequence title, PendingIntent intent, Bundle extras, RemoteInput[] remoteInputs, RemoteInput[] dataOnlyRemoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual) {
            this(icon != 0 ? IconCompat.createWithResource(null, RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED, icon) : null, title, intent, extras, remoteInputs, dataOnlyRemoteInputs, allowGeneratedReplies, semanticAction, showsUserInterface, isContextual);
        }
        ...
        public static final class Builder {
            ...
            public Builder(int icon, CharSequence title, PendingIntent intent) {
                this(icon != 0 ? IconCompat.createWithResource(null, RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED, icon) : null, title, intent, new Bundle(), null, true, 0, true, false);
            }
