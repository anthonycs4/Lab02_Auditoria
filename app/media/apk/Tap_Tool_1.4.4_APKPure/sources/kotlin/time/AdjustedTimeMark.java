...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1299getAdjustmentUwyO8pc() {
    ...
    public long mo1297elapsedNowUwyO8pc() {
        return Duration.m1341minusLRDsOJo(this.mark.mo1297elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1298plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1342plusLRDsOJo(this.adjustment, j));
    }
}
