...
public final class UStringsKt {
    ...
    public static final String m1296toStringolVBNx4(short s, int i) {
    ...
    public static final String m1295toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1293toStringJSWoG40(long j, int i) {
    ...
    public static final short toUShort(String toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m349unboximpl();
        }
    ...
    public static final long toULong(String toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m245unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int i) {
        ...
        if (uIntOrNull != null) {
            int m167unboximpl = uIntOrNull.m167unboximpl();
            if (UnsignedKt.uintCompare(m167unboximpl, UInt.m116constructorimpl(255)) > 0) {
                return null;
            }
            return UByte.m34boximpl(UByte.m40constructorimpl((byte) m167unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        if (uIntOrNull != null) {
            int m167unboximpl = uIntOrNull.m167unboximpl();
            if (UnsignedKt.uintCompare(m167unboximpl, UInt.m116constructorimpl(SupportMenu.USER_MASK)) > 0) {
                return null;
            }
            return UShort.m294boximpl(UShort.m300constructorimpl((short) m167unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int m116constructorimpl = UInt.m116constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m369uintDivideJ1ME1BU(-1, m116constructorimpl);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int m116constructorimpl2 = UInt.m116constructorimpl(i2 * m116constructorimpl);
            int m116constructorimpl3 = UInt.m116constructorimpl(UInt.m116constructorimpl(digitOf) + m116constructorimpl2);
            if (UnsignedKt.uintCompare(m116constructorimpl3, m116constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = m116constructorimpl3;
        }
        return UInt.m110boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long m194constructorimpl = ULong.m194constructorimpl(i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m371ulongDivideeb3DHEI(j, m194constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long m194constructorimpl2 = ULong.m194constructorimpl(j2 * m194constructorimpl);
            long m194constructorimpl3 = ULong.m194constructorimpl(ULong.m194constructorimpl(UInt.m116constructorimpl(digitOf) & 4294967295L) + m194constructorimpl2);
            if (UnsignedKt.ulongCompare(m194constructorimpl3, m194constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = m194constructorimpl3;
            j = -1;
        }
        return ULong.m188boximpl(j2);
    }
}
