...
final class zzfxv extends zzfwu<Double> implements RandomAccess, zzfyv, zzgab {
    private static final zzfxv zza;
    private double[] zzb;
    private int zzc;

    static {
        zzfxv zzfxvVar = new zzfxv(new double[0], 0);
        zza = zzfxvVar;
        zzfxvVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        ...
        if (!(collection instanceof zzfxv)) {
            return super.addAll(collection);
        }
        zzfxv zzfxvVar = (zzfxv) collection;
        int i = zzfxvVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzfxvVar.zzb, 0, this.zzb, this.zzc, zzfxvVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof zzfxv)) {
            return super.equals(obj);
        }
        zzfxv zzfxvVar = (zzfxv) obj;
        if (this.zzc != zzfxvVar.zzc) {
            return false;
        }
        double[] dArr = zzfxvVar.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzfyw.zze(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
    ...
    public final /* bridge */ /* synthetic */ zzfyv zze(int i) {
        if (i >= this.zzc) {
            return new zzfxv(Arrays.copyOf(this.zzb, i), this.zzc);
        }
        throw new IllegalArgumentException();
    }

    private zzfxv(double[] dArr, int i) {
        this.zzb = dArr;
        this.zzc = i;
    }
