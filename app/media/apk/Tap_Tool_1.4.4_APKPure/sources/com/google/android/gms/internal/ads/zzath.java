...
public final class zzath extends Thread {
    ...
    public zzath() {
        ...
        this.zzd = zzasyVar;
        this.zzc = new Object();
        this.zzf = zzbgx.zzd.zze().intValue();
        this.zzg = zzbgx.zza.zze().intValue();
        this.zzh = zzbgx.zze.zze().intValue();
        this.zzi = zzbgx.zzc.zze().intValue();
        this.zzj = ((Integer) zzbba.zzc().zzb(zzbfq.zzN)).intValue();
        this.zzk = ((Integer) zzbba.zzc().zzb(zzbfq.zzO)).intValue();
        this.zzl = ((Integer) zzbba.zzc().zzb(zzbfq.zzP)).intValue();
        this.zze = zzbgx.zzf.zze().intValue();
        this.zzm = (String) zzbba.zzc().zzb(zzbfq.zzR);
        this.zzn = ((Boolean) zzbba.zzc().zzb(zzbfq.zzS)).booleanValue();
        this.zzo = ((Boolean) zzbba.zzc().zzb(zzbfq.zzT)).booleanValue();
        this.zzp = ((Boolean) zzbba.zzc().zzb(zzbfq.zzU)).booleanValue();
    ...
    */
    public final void run() {
        /*
            r6 = this;
        L0:
            com.google.android.gms.internal.ads.zzatc r0 = com.google.android.gms.ads.internal.zzs.zzf()     // Catch: java.lang.Throwable -> La8
        ...
        L2a:
            ...
            if (r0 == 0) goto Lb2
            com.google.android.gms.internal.ads.zzatc r0 = com.google.android.gms.ads.internal.zzs.zzf()     // Catch: java.lang.Exception -> Lc3 java.lang.InterruptedException -> Ld3
        ...
        L8e:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzcby r2 = com.google.android.gms.ads.internal.zzs.zzg()     // Catch: java.lang.Exception -> Lc3 java.lang.InterruptedException -> Ld3
            java.lang.String r3 = "ContentFetchTask.extractContent"
            r2.zzg(r0, r3)     // Catch: java.lang.Exception -> Lc3 java.lang.InterruptedException -> Ld3
            java.lang.String r0 = "Failed getting root view of activity. Content not extracted."
            com.google.android.gms.ads.internal.util.zze.zzd(r0)     // Catch: java.lang.Exception -> Lc3 java.lang.InterruptedException -> Ld3
        L9d:
            if (r1 == 0) goto Lba
            com.google.android.gms.internal.ads.zzatd r0 = new com.google.android.gms.internal.ads.zzatd     // Catch: java.lang.Exception -> Lc3 java.lang.InterruptedException -> Ld3
        ...
        La8:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzcby r1 = com.google.android.gms.ads.internal.zzs.zzg()     // Catch: java.lang.Exception -> Lc3 java.lang.InterruptedException -> Ld3
            java.lang.String r2 = "ContentFetchTask.isInForeground"
            r1.zzg(r0, r2)     // Catch: java.lang.Exception -> Lc3 java.lang.InterruptedException -> Ld3
        Lb2:
        ...
        Lc3:
            ...
            com.google.android.gms.internal.ads.zzcby r1 = com.google.android.gms.ads.internal.zzs.zzg()
    ...
    public final void zzb(View view) {
        try {
            zzasx zzasxVar = new zzasx(this.zzf, this.zzg, this.zzh, this.zzi, this.zzj, this.zzk, this.zzl, this.zzo);
            ...
            zzatg zzc = zzc(view, zzasxVar);
            zzasxVar.zzk();
            if (zzc.zza == 0 && zzc.zzb == 0) {
                return;
            }
            if (zzc.zzb == 0 && zzasxVar.zzo() == 0) {
                return;
            }
            if (zzc.zzb == 0 && this.zzd.zzb(zzasxVar)) {
                return;
            }
            this.zzd.zzd(zzasxVar);
        } catch (Exception e) {
    ...
    final zzatg zzc(View view, zzasx zzasxVar) {
        if (view == null) {
            return new zzatg(this, 0, 0);
        }
        ...
        if (!(view instanceof TextView) || (view instanceof EditText)) {
            if (!(view instanceof WebView) || (view instanceof zzcib)) {
                if (view instanceof ViewGroup) {
                    ...
                    for (int i3 = 0; i3 < viewGroup.getChildCount(); i3++) {
                        zzatg zzc = zzc(viewGroup.getChildAt(i3), zzasxVar);
                        i += zzc.zza;
                        i2 += zzc.zzb;
                    }
                    return new zzatg(this, i, i2);
                }
                return new zzatg(this, 0, 0);
            }
            ...
            zzasxVar.zzg();
            webView.post(new zzatf(this, zzasxVar, webView, globalVisibleRect));
            return new zzatg(this, 0, 1);
        }
        CharSequence text = ((TextView) view).getText();
        if (!TextUtils.isEmpty(text)) {
            zzasxVar.zzi(text.toString(), globalVisibleRect, view.getX(), view.getY(), view.getWidth(), view.getHeight());
            return new zzatg(this, 1, 0);
        }
        return new zzatg(this, 0, 0);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void zzd(zzasx zzasxVar, WebView webView, String str, boolean z) {
        zzasxVar.zzf();
        try {
