...
abstract class zzfvd implements zzfvy {
    ...
    public final void zzd(ByteBuffer byteBuffer, byte[] bArr) throws GeneralSecurityException {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (i2 == i - 1) {
                zzfvb.zzc(byteBuffer, wrap, zze, remaining % 64);
            } else {
                zzfvb.zzc(byteBuffer, wrap, zze, 64);
            }
        }
    }
