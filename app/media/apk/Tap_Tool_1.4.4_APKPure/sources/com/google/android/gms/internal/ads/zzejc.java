...
final /* synthetic */ class zzejc implements Callable {
    static final Callable zza = new zzejc();
    ...
    public final Object call() {
        ...
        if (((Boolean) zzbba.zzc().zzb(zzbfq.zzE)).booleanValue()) {
        ...
        bundle.putInt("web_view_count", com.google.android.gms.ads.internal.zzs.zzg().zzk());
        return new zzeje(bundle);
    }
}
