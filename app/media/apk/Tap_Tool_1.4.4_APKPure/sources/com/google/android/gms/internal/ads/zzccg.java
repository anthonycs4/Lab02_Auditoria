...
public final class zzccg {
    public static final Handler zza = new zzfdx(Looper.getMainLooper());
    ...
    public static boolean zzi(String str) {
        ...
        return str.startsWith(zzbhj.zzd.zze());
    }
    ...
    public static final void zzr(Context context, String str, String str2, Bundle bundle, boolean z, zzccf zzccfVar) {
        ...
        zzccfVar.zza(appendQueryParameter.toString());
    }
    ...
    private static final void zzu(ViewGroup viewGroup, zzazx zzazxVar, String str, int i, int i2) {
        ...
        frameLayout.addView(textView, new FrameLayout.LayoutParams(zzazxVar.zzf - zzs, zzazxVar.zzc - zzs, 17));
        viewGroup.addView(frameLayout, zzazxVar.zzf, zzazxVar.zzc);
    }
    ...
    public final void zzb(ViewGroup viewGroup, zzazx zzazxVar, String str, String str2) {
        if (str2 != null) {
            zzccn.zzi(str2);
        }
        zzu(viewGroup, zzazxVar, str, SupportMenu.CATEGORY_MASK, ViewCompat.MEASURED_STATE_MASK);
    }

    public final void zzc(ViewGroup viewGroup, zzazx zzazxVar, String str) {
        zzu(viewGroup, zzazxVar, "Ads by Google", ViewCompat.MEASURED_STATE_MASK, -1);
    }

    public final void zze(Context context, String str, String str2, Bundle bundle, boolean z) {
        zzr(context, str, "gmob-apps", bundle, true, new zzcce(this));
    }
}
