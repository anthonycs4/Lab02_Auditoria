...
final class zzbtr implements MediationAdLoadCallback<MediationInterscrollerAd, MediationBannerAdCallback> {
    ...
    public final /* bridge */ /* synthetic */ MediationBannerAdCallback onSuccess(MediationInterscrollerAd mediationInterscrollerAd) {
        ...
        try {
            this.zza.zzh(new zzbse(mediationInterscrollerAd2));
