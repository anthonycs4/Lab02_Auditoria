...
final class zzgn extends zzgj<Boolean> implements zzig<Boolean>, zzjv, RandomAccess {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzgnVar.zzc) {
            return false;
        }
        boolean[] zArr = zzgnVar.zzb;
    ...
    public final boolean addAll(Collection<? extends Boolean> collection) {
        ...
        System.arraycopy(zzgnVar.zzb, 0, this.zzb, this.zzc, zzgnVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    static {
        zzgn zzgnVar = new zzgn(new boolean[0], 0);
        zza = zzgnVar;
        zzgnVar.i_();
    }
}
