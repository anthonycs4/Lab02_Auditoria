...
interface zzlm {
    ...
    void zza(int i, zzgp zzgpVar) throws IOException;

    <K, V> void zza(int i, zzja<K, V> zzjaVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzkb zzkbVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzkb zzkbVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzkb zzkbVar) throws IOException;

    void zzb(int i, List<zzgp> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzkb zzkbVar) throws IOException;
