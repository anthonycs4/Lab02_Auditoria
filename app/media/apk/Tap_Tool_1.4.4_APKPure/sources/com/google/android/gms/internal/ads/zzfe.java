...
public final class zzfe {
    ...
    public zzfe(SecureRandom secureRandom) {
    }
    ...
    public final String zza(byte[] bArr, byte[] bArr2) throws zzfd {
        byte[] doFinal;
        byte[] iv;
        ...
        try {
            ...
            throw new zzfd(this, e);
        } catch (NoSuchAlgorithmException e2) {
            throw new zzfd(this, e2);
        } catch (BadPaddingException e3) {
            throw new zzfd(this, e3);
        } catch (IllegalBlockSizeException e4) {
            throw new zzfd(this, e4);
        } catch (NoSuchPaddingException e5) {
            throw new zzfd(this, e5);
        }
    }

    public final byte[] zzb(byte[] bArr, String str) throws zzfd {
        byte[] doFinal;
        int length = bArr.length;
        try {
            ...
            throw new zzfd(this, e6);
        } catch (NoSuchPaddingException e7) {
            throw new zzfd(this, e7);
        }
    }
}
