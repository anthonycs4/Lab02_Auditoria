...
public final class AdSize {
    ...
    public static final AdSize WIDE_SKYSCRAPER = new AdSize(160, TypedValues.Motion.TYPE_STAGGER, "160x600_as");
    @Deprecated
    ...
    */
    ...
    public static AdSize getCurrentOrientationInterscrollerAdSize(Context context, int i) {
        return zzj(i, zzccg.zzj(context, 0));
    }
    ...
    public static AdSize getPortraitInterscrollerAdSize(Context context, int i) {
        return zzj(i, zzccg.zzj(context, 1));
    }
    ...
    public int getHeightInPixels(Context context) {
        ...
        if (i == -2) {
            return zzazx.zza(context.getResources().getDisplayMetrics());
        }
        zzbay.zza();
        return zzccg.zzs(context, this.zzc);
    }
    ...
    public int getWidthInPixels(Context context) {
        ...
        if (i != -3) {
            ...
            zzbay.zza();
            return zzccg.zzs(context, this.zzb);
        }
        return -1;
    }
