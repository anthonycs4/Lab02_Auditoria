...
public final class zzfxr extends zzfxt {
    ...
    @Override // com.google.android.gms.internal.ads.zzfxt
    public final void zzi(int i, zzfxj zzfxjVar) throws IOException {
        zzl((i << 3) | 2);
        zzl(zzfxjVar.zzc());
        zzfxjVar.zzk(this);
    }
    ...
    public final void zzl(int i) throws IOException {
        ...
        while ((i & (-128)) != 0) {
            try {
                ...
                throw new zzfxs(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1), e);
            }
        }
        byte[] bArr2 = this.zzb;
        int i4 = this.zzd;
    ...
    public final void zzr(String str) throws IOException {
        ...
        try {
            ...
            if (zzw2 != zzw) {
                ...
                byte[] bArr = this.zzb;
                int i2 = this.zzd;
                this.zzd = zzgbn.zze(str, bArr, i2, this.zzc - i2);
                return;
            }
            int i3 = i + zzw2;
            this.zzd = i3;
            int zze = zzgbn.zze(str, this.zzb, i3, this.zzc - i3);
            this.zzd = i;
            zzl((zze - i) - zzw2);
            this.zzd = zze;
        } catch (zzgbm e) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzfxr(byte[] bArr, int i, int i2) {
        super(null);
    ...
    public final void zzp(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzfxs(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)), e);
        }
    }
    ...
    public final void zzn(long j) throws IOException {
        ...
        while ((j & (-128)) != 0) {
            ...
            int i3 = this.zzd;
            this.zzd = i3 + 1;
            zzgbi.zzp(bArr3, i3, (byte) ((((int) j) & 127) | 128));
            j >>>= 7;
        }
        byte[] bArr4 = this.zzb;
        int i4 = this.zzd;
        this.zzd = i4 + 1;
        zzgbi.zzp(bArr4, i4, (byte) j);
    }
}
