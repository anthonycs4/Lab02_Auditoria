...
public final class zzeli implements zzelc<Bundle> {
    ...
    public zzeli(boolean z, boolean z2, String str, boolean z3, boolean z4, boolean z5, String str2, ArrayList<String> arrayList, @Nullable String str3, @Nullable String str4, String str5, boolean z6, String str6, long j) {
        this.zza = z;
        this.zzb = z2;
        this.zzc = str;
        this.zzd = z3;
    ...
    public final /* bridge */ /* synthetic */ void zzd(Bundle bundle) {
        ...
        Bundle zza2 = zzetw.zza(zza, "browser");
        zza.putBundle("browser", zza2);
        zza2.putBoolean("is_browser_custom_tabs_capable", this.zzl);
        if (TextUtils.isEmpty(this.zzj)) {
            return;
        }
        Bundle zza3 = zzetw.zza(zza, "play_store");
