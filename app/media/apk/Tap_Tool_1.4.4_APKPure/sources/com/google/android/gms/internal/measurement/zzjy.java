...
public interface zzjy {
    ...
    <T> T zza(zzkb<T> zzkbVar, zzhl zzhlVar) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzkb<T> zzkbVar, zzhl zzhlVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzja<K, V> zzjaVar, zzhl zzhlVar) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzkb<T> zzkbVar, zzhl zzhlVar) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzkb<T> zzkbVar, zzhl zzhlVar) throws IOException;
