...
public final class zzfuw implements zzflu {
    private static final ThreadLocal<Cipher> zza = new zzfuu();
    private static final ThreadLocal<Cipher> zzb = new zzfuv();
    ...
    public zzfuw(byte[] bArr, int i) throws GeneralSecurityException {
        if (i == 12 || i == 16) {
            this.zzf = i;
