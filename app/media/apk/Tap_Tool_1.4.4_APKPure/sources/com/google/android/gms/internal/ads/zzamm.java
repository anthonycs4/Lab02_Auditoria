...
final class zzamm {
    ...
    public final long zze(zzalt zzaltVar, boolean z, boolean z2, int i) throws IOException, InterruptedException {
        if (this.zzc == 0) {
            if (!zzaltVar.zzb(this.zzb, 0, 1, z)) {
                return -1L;
            }
        ...
        if (i2 != 1) {
            zzaltVar.zzb(this.zzb, 1, i2 - 1, false);
        }
        this.zzc = 0;
