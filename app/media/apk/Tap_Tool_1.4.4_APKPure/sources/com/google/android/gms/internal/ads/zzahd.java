...
public final class zzahd {
    ...
    public final String zzF(int i) {
        ...
        int i2 = this.zzb;
        int i3 = (i2 + i) - 1;
        String zzq = zzaht.zzq(this.zza, i2, (i3 >= this.zzc || this.zza[i3] != 0) ? i : i - 1);
        this.zzb += i;
        return zzq;
    }
    ...
    public final String zzG(char c) {
        ...
        if (i - i2 != 0) {
            ...
            byte[] bArr = this.zza;
            int i3 = this.zzb;
            String zzq = zzaht.zzq(bArr, i3, i2 - i3);
            this.zzb = i2;
            if (i2 < this.zzc) {
                this.zzb = i2 + 1;
            }
    ...
    public final void zzl(zzahc zzahcVar, int i) {
        zzm(zzahcVar.zza, 0, i);
        zzahcVar.zzd(0);
    }
